...
def test():
    ...
    list_= ['15','20','23','24','25','26','27']
    for item in list_:
        print("current is model : %s\n"%item)

        model_name = 'epoch_%s'%item
        ensemble_name = 'conv_224_%s'%model_name
        ...
        for x in f:
            ...
            if (i%200==0):
                #print(map_)
                result.to_csv("./result/predict.csv",index=False)
                #print("predict.csv saved...")
            '''    
